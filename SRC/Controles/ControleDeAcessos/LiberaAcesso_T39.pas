...
type
  TfrmLiberaAcesso_T39 = class(TForm)
    pnSenhaPreco: TPanel;
    Label75: TLabel;
    edUsuario: TEdit;
...
var
  frmLiberaAcesso_T39: TfrmLiberaAcesso_T39;
...
procedure TfrmLiberaAcesso_T39.bPermissoesClick(Sender: TObject);
begin
...
procedure TfrmLiberaAcesso_T39.btSenhaPrecoClick(Sender: TObject);
begin
  VerificaAcesso;
end;

procedure TfrmLiberaAcesso_T39.VerificaAcesso;
var qLocal : TFDQuery;
begin
...
procedure TfrmLiberaAcesso_T39.edUsuarioExit(Sender: TObject);
begin
...
procedure TfrmLiberaAcesso_T39.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
   if key = #27 Then
   begin
...
procedure TfrmLiberaAcesso_T39.FormShow(Sender: TObject);
begin
