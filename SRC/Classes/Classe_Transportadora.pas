...
begin
   //Histórico de bloqueios e desbloqueios da Transportadora
   qLocal.Close;
   qLocal.Sql.Clear;
...
begin
   try
       ...
       Avisos.Avisar('Erro ao alterar Endereço do Transportadora '+ FNomeFantasia);
       LogErros('Classe_Transportadora','Erro ao alterar Endereço do Transportadora '+ FNomeFantasia);
    end;
end;
