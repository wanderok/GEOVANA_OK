...
type
  TfrmConsulta_CPFT14 = class(TForm)
    Panel2: TPanel;
    Label3: TLabel;
    Label12: TLabel;
...
var
  frmConsulta_CPFT14: TfrmConsulta_CPFT14;

implementation

{$R *.dfm}

procedure TfrmConsulta_CPFT14.btnConsultarClick(Sender: TObject);
begin
   if btnConsultar.Caption = 'Consultar' then
      Buscar
   else
      Aplicar;
end;

procedure TfrmConsulta_CPFT14.Aplicar;
begin
     Close;
end;

procedure TfrmConsulta_CPFT14.Buscar;
begin
...
procedure TfrmConsulta_CPFT14.FormShow(Sender: TObject);
begin
  Timer1.Enabled := True;
  EditCaptcha.SetFocus;
end;

procedure TfrmConsulta_CPFT14.LabAtualizarCaptchaClick(Sender: TObject);
var
...
procedure TfrmConsulta_CPFT14.Timer1Timer(Sender: TObject);
begin
