...
type
  TfrmConsulta_CPF_T14 = class(TForm)
    Panel2: TPanel;
    Label3: TLabel;
    Label12: TLabel;
...
var
  frmConsulta_CPF_T14: TfrmConsulta_CPF_T14;

implementation

{$R *.dfm}

procedure TfrmConsulta_CPF_T14.btnConsultarClick(Sender: TObject);
begin
...
procedure TfrmConsulta_CPF_T14.FormShow(Sender: TObject);
begin
  Timer1.Enabled := True;
  EditCaptcha.SetFocus;
end;

procedure TfrmConsulta_CPF_T14.LabAtualizarCaptchaClick(Sender: TObject);
var
...
procedure TfrmConsulta_CPF_T14.Timer1Timer(Sender: TObject);
begin
