...
uses
  ...
  Classe_Transportadora, ACBrBase, ACBrSocket, ACBrCEP, Vcl.Grids;

type
  Tfrm_cad_transportadora_T28 = class(TForm)
    gpData: TGroupBox;
    Label13: TLabel;
    lbInativo: TLabel;
    Label14: TLabel;
    ...
    function Gravar_Transportadora:Boolean;
    procedure Pesquisar;
    procedure Consultar;
...
var
  frm_cad_transportadora_T28: Tfrm_cad_transportadora_T28;
...
procedure Tfrm_cad_transportadora_T28.cxButton1Click(Sender: TObject);
begin
    pesquisar_CNPJ_na_SEFAZ;
end;

procedure Tfrm_cad_transportadora_T28.pesquisar_CNPJ_na_SEFAZ;
begin
...
begin
   ...
   if not Gravar_Transportadora then
     exit;

   {
   vNuvem:= TNuvem.Create;
   vNuvem.uploadTransportadora(Transportadora);
   FreeAndNil(vNuvem);
   }
   Transportadora.Free;
   Inicio;
...
procedure Tfrm_cad_transportadora_T28.cxButton28Click(Sender: TObject);
begin
   vPodeFechar:=True;
   Close;
end;

procedure Tfrm_cad_transportadora_T28.cxButton2Click(Sender: TObject);
begin
   pesquisar_CPF_na_SEFAZ;
end;

procedure Tfrm_cad_transportadora_T28.pesquisar_CPF_na_SEFAZ;
begin
...
procedure Tfrm_cad_transportadora_T28.bPesqMunicipioClick(Sender: TObject);
begin
   PesquisaMunicipio;
end;

procedure Tfrm_cad_transportadora_T28.cxButton4Click(Sender: TObject);
begin
    PesquisaRegiao;
end;

procedure Tfrm_cad_transportadora_T28.cxButton8Click(Sender: TObject);
begin
  Consultar;
end;

procedure Tfrm_cad_transportadora_T28.PesquisaRegiao;
Begin
...
procedure Tfrm_cad_transportadora_T28.PesquisaZona;
begin
...
procedure Tfrm_cad_transportadora_T28.ACBrCEP1BuscaEfetuada(Sender: TObject);
...
procedure Tfrm_cad_transportadora_T28.bHistoricoAlteracoesClick(Sender: TObject);
begin
   ...
   begin
     ...
     SQL.Add(' where log_historico like :Transportadora ');
     ParamByName('Transportadora').AsString := '%' + 'Transportadora ' + edCodigo.Text + '%';
...
procedure Tfrm_cad_transportadora_T28.bPesqBairroClick(Sender: TObject);
begin
    PesquisaBairro;
end;

procedure Tfrm_cad_transportadora_T28.bPesqZonaClick(Sender: TObject);
begin
   PesquisaZona;
end;

procedure Tfrm_cad_transportadora_T28.btDetalhesBloqueioClick(Sender: TObject);
begin
    if trim(edCodigo.Text) = '' then
       exit;

    // Mostra detalhes do bloqueio...
    // Data, hora, usuário e estação onde ocorreu o bloqueio do Transportadora
    // ----------------------------------------------------------------------------
    frmTRANSPORTADORA_HISTORICO_BLOQUEIOS_TRAHB_T29 :=  TfrmTRANSPORTADORA_HISTORICO_BLOQUEIOS_TRAHB_T29.Create(Self);
    with frmTRANSPORTADORA_HISTORICO_BLOQUEIOS_TRAHB_T29.sql_TRANSPORTADORA_HISTORICO_BLOQUEIOS_TRAHB do
    begin
      Close;
      Sql.Clear;
      Sql.Add('SELECT *                                           ');
    ...
    frmTRANSPORTADORA_HISTORICO_BLOQUEIOS_TRAHB_T29.Free;
end;

procedure Tfrm_cad_transportadora_T28.Consultar;
begin
    frm_consulta_T7 := Tfrm_consulta_T7.Create(nil);
    frm_consulta_T7.rgConsultar.itemindex := 6; //Transportadora
...
function Tfrm_cad_transportadora_T28.DadosCorretos: Boolean;
...
begin
   ...
   if NaoPreencheuCamposObrigatoriosOuImportantes(frm_cad_transportadora_T28) then
      exit;
...
function Tfrm_cad_transportadora_T28.FormataIE: Boolean;
begin
   result := true;
...
procedure Tfrm_cad_transportadora_T28.edBairroExit(Sender: TObject);
begin
...
procedure Tfrm_cad_transportadora_T28.edCEPExit(Sender: TObject);
...
procedure Tfrm_cad_transportadora_T28.edCEPKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_transportadora_T28.edCidadeExit(Sender: TObject);
begin
   TrataCidade;
end;

procedure Tfrm_cad_transportadora_T28.edCNPJEnter(Sender: TObject);
begin
   (Sender as TEdit).Text := SoNumerosOuISENTO((Sender as TEdit).Text);
end;

procedure Tfrm_cad_transportadora_T28.edCNPJExit(Sender: TObject);
begin
...
procedure Tfrm_cad_transportadora_T28.edCNPJKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_transportadora_T28.edCodigoExit(Sender: TObject);
begin
   Pesquisar;
end;

procedure Tfrm_cad_transportadora_T28.edCodigoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   if key = vk_F1 then
     Consultar;
...
procedure Tfrm_cad_transportadora_T28.edCPFExit(Sender: TObject);
begin
...
procedure Tfrm_cad_transportadora_T28.edCPFKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_transportadora_T28.edDataNascimentoExit(Sender: TObject);
begin
...
procedure Tfrm_cad_transportadora_T28.edEnderecoMunicipioIBGEExit(Sender: TObject);
begin
    SelectMunicipio(edEnderecoMunicipioIBGE.text,edCidade);
end;

function Tfrm_cad_transportadora_T28.SelectMunicipio(pMunicipio:String;pMunicipioNome:TEdit):Boolean;
begin
...
procedure Tfrm_cad_transportadora_T28.edIEExit(Sender: TObject);
begin
...
procedure Tfrm_cad_transportadora_T28.edIEKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tfrm_cad_transportadora_T28.edCelKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_transportadora_T28.edFone1Exit(Sender: TObject);
begin
   if not TelValido((Sender as TEdit)) then
      (Sender as TEdit).SetFocus;
end;

procedure Tfrm_cad_transportadora_T28.edFone2KeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_transportadora_T28.edWhatsAppKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_transportadora_T28.edZonaExit(Sender: TObject);
begin
...
procedure Tfrm_cad_transportadora_T28.edNOMEExit(Sender: TObject);
begin
...
procedure Tfrm_cad_transportadora_T28.edNOMEKeyPress(Sender: TObject; var Key: Char);
begin
   key := fSemAcentos(key);
end;

procedure Tfrm_cad_transportadora_T28.edNumeroKeyPress(Sender: TObject; var Key: Char);
begin
     key := fLetrasENumeros(key);
end;

procedure Tfrm_cad_transportadora_T28.edRegiaoExit(Sender: TObject);
begin
...
procedure Tfrm_cad_transportadora_T28.edRGExit(Sender: TObject);
begin
...
procedure Tfrm_cad_transportadora_T28.edRG_DataEmissaoExit(Sender: TObject);
begin
   if DataNoFuturo((Sender as TMaskEdit)) then
      (Sender as TEdit).SetFocus;
end;

procedure Tfrm_cad_transportadora_T28.PesquisaBairro;
begin
...
procedure Tfrm_cad_transportadora_T28.PesquisaMunicipio;
begin
...
procedure Tfrm_cad_transportadora_T28.Pesquisar;
var vCodigo:String;
begin
   ...
   Transportadora.Codigo := edCodigo.Text;
   Transportadora.Abrir;
...
procedure Tfrm_cad_transportadora_T28.FormClose(Sender: TObject;
...
begin
   try
     if vMemoLocal = nil then
        vMemoLocal:=TMemo.Create(frm_cad_transportadora_T28)
     else
     begin
        vMemoLocal.Free;
        vMemoLocal:=TMemo.Create(frm_cad_transportadora_T28);
...
procedure Tfrm_cad_transportadora_T28.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   if key = vk_f1 Then
   begin
...
procedure Tfrm_cad_transportadora_T28.FormKeyPress(Sender: TObject; var Key: Char);
begin
     if Key = #13 then
     begin
...
procedure Tfrm_cad_transportadora_T28.FormShow(Sender: TObject);
begin
   Inicio;
end;

function Tfrm_cad_transportadora_T28.fPessoaFisica: Boolean;
begin
   result := (fTipoPessoa_JF = 'F');
end;

function Tfrm_cad_transportadora_T28.fPessoaJuridica: Boolean;
begin
   result := (fTipoPessoa_JF = 'J');
end;

function Tfrm_cad_transportadora_T28.fPreencheu_Algum_Campo_Pessoa_Fisica: Boolean;
begin
   Result := false;
...
function Tfrm_cad_transportadora_T28.fPreencheu_Algum_Campo_Pessoa_Juridica: Boolean;
begin
   Result := false;
...
function Tfrm_cad_transportadora_T28.fTipoPessoa_JF: String;
begin
    Result := '';
...
function Tfrm_cad_transportadora_T28.Gravar_Transportadora: Boolean;
...
begin
    ...
    try
        ...
        if fPessoaFisica then
        begin
           Transportadora.NomeFantasia             := edNome.Text;
           Transportadora.RazaoSocial              := '';
           with Transportadora.Detalhes.PessoaFisica do
           begin
              CPF            := edCPF.Text;
              RG             := edRG.Text;
        ...
        begin
           Transportadora.NomeFantasia             := edNomeFantasia.Text;
           Transportadora.RazaoSocial              := edRazaoSocial.Text;
           with Transportadora.Detalhes.PessoaFisica do
           begin
              RG             := '';
              RG_OrgaoEmissor:= '';
           ...
           with Transportadora.Detalhes.PessoaJuridica do
           begin
              CNPJ           := edCNPJ.Text;
              IE             := edIE.Text;
           end;
        ...
        Transportadora.Status                        := IntToStatusCadastral(rgStatus.ItemIndex);
        Transportadora.Detalhes.TipoPessoa           := StringToTipoPessoa(fTipoPessoa_JF);
        if rgStatus.ItemIndex = -1 then
           rgStatus.ItemIndex := 0;

        if rgStatus.ItemIndex = 1 then
           Transportadora.Alteracao.DataBloqueio     := sDataServidor
        else
           Transportadora.Alteracao.DataBloqueio     := '  /  /  ';
        if rgStatus.ItemIndex = 2 then
           Transportadora.Alteracao.DataInativo    := sDataServidor
        else
           Transportadora.Alteracao.DataInativo    := '  /  /  ';


        Transportadora.Detalhes.Regiao               := edRegiao.Text;
        Transportadora.Detalhes.Zona                 := edZona.Text;
        Transportadora.Detalhes.RNTC                 := edRNTC.Text;
        Transportadora.Detalhes.Endereco.Rua         := edRua.Text;
        Transportadora.Detalhes.Endereco.Numero      := edNumero.Text;
        Transportadora.Detalhes.Endereco.Bairro      := edBairro.Text;
        Transportadora.Detalhes.Endereco.Complemento := edComplemento.Text;
        Transportadora.Detalhes.Endereco.Cidade      := edEnderecoMunicipioIBGE.Text;
        Transportadora.Detalhes.Endereco.CEP         := edCEP.Text;

        Transportadora.Detalhes.Contato.Fone1        := edFone1.Text;
        Transportadora.Detalhes.Contato.Fone2        := edFone2.Text;
        Transportadora.Detalhes.Contato.Nome         := edNomeContato.Text;
        Transportadora.Detalhes.Contato.Cel          := edCel.Text;
        Transportadora.Detalhes.Contato.WhatsApp     := edWhatsApp.Text;
        Transportadora.Detalhes.Contato.Email1       := edEmail1.Text;
        Transportadora.Detalhes.Contato.Email2       := edEmail2.Text;

        Lista := TStringList.Create;
        for i := 0 to vMemoLocal.lines.count-1 do
            Lista.Add(vMemoLocal.lines[i]);

        Transportadora.Observacao                    := Lista;
        result := Transportadora.Gravar;
    Except

    end;
end;

procedure Tfrm_cad_transportadora_T28.Inicio;
begin
...
procedure Tfrm_cad_transportadora_T28.mmObservacoesClick(Sender: TObject);
begin
...
begin
   ...
   rgStatus.ItemIndex := StatusCadastralToInt(Transportadora.Status);
...
procedure Tfrm_cad_transportadora_T28.Preencher_Contato;
begin
   edFone1.Text             := Transportadora.Detalhes.Contato.Fone1;
   edFone2.Text             := Transportadora.Detalhes.Contato.Fone2;
   edNomeContato.Text       := Transportadora.Detalhes.Contato.Nome;
   edCel.Text               := Transportadora.Detalhes.Contato.Cel;
   edWhatsApp.Text          := Transportadora.Detalhes.Contato.WhatsApp;
   edEmail1.Text            := Transportadora.Detalhes.Contato.Email1;
   edEmail2.Text            := Transportadora.Detalhes.Contato.Email2;
end;

procedure Tfrm_cad_transportadora_T28.Preencher_Dados_Comuns;
begin
   Preencher_Endereco;
   Preencher_Contato;
...
procedure Tfrm_cad_transportadora_T28.Preencher_Dados_Pessoa;
begin
   if Transportadora.Detalhes.TipoPessoa = tpFisica then
      Preencher_Dados_Pessoa_Fisica
   else
      Preencher_Dados_Pessoa_Juridica;
end;

procedure Tfrm_cad_transportadora_T28.Preencher_Dados_Pessoa_Fisica;
begin
   pgControlPessoa.ActivePage := tsPessoaFisica;
   edNome.Text                := Transportadora.NomeFantasia;
   edCPF.Text                 := Transportadora.Detalhes.PessoaFisica.CPF;
   edRG.Text                  := Transportadora.Detalhes.PessoaFisica.RG;
   edRG_OrgaoEmissor.Text     := Transportadora.Detalhes.PessoaFisica.RG_OrgaoEmissor;
   edRG_DataEmissao.Text      := Transportadora.Detalhes.PessoaFisica.RG_DataEmissao;
   edDataNascimento.Text      := Transportadora.Detalhes.PessoaFisica.DataNascimento;
   cbSexo.ItemIndex           := Transportadora.Detalhes.PessoaFisica.Sexo;
end;

procedure Tfrm_cad_transportadora_T28.Preencher_Dados_Pessoa_Juridica;
begin
   pgControlPessoa.ActivePage := tsPessoaJuridica;
   edCNPJ.Text                := Transportadora.Detalhes.PessoaJuridica.CNPJ;
   edIE.Text                  := Transportadora.Detalhes.PessoaJuridica.IE;
   edNomeFantasia.Text        := Transportadora.NomeFantasia;
   edRazaoSocial.Text         := Transportadora.RazaoSocial;
end;

procedure Tfrm_cad_transportadora_T28.Preencher_Endereco;
begin
   edRegiao.Text                      := Transportadora.Detalhes.Regiao;
   edZona.Text                        := Transportadora.Detalhes.Zona;
   edRNTC.Text                        := Transportadora.Detalhes.RNTC;
   edRua.Text                         := Transportadora.Detalhes.Endereco.Rua;
   edNumero.Text                      := Transportadora.Detalhes.Endereco.Numero;
   edBairro.Text                      := Transportadora.Detalhes.Endereco.Bairro;
   edComplemento.Text                 := Transportadora.Detalhes.Endereco.Complemento;
   edEnderecoMunicipioIBGE.Text       := Transportadora.Detalhes.Endereco.Cidade;
   edCEP.Text                         := Transportadora.Detalhes.Endereco.CEP;
...
procedure Tfrm_cad_transportadora_T28.Preencher_Historicos;
begin
   edDataCadastro.Text := Transportadora.Detalhes.DataCadastroString;
   edDataBloqueio.Text := Transportadora.Alteracao.DataBloqueio;
   edDataInativo.Text  := Transportadora.Alteracao.DataInativo;
   edUSU.Text          := Transportadora.Alteracao.Usuario;
   edDT.Text           := Transportadora.Alteracao.Data;
   edHR.Text           := Transportadora.Alteracao.Hora;
   edEstacao.Text      := Transportadora.Alteracao.Estacao;
end;

procedure Tfrm_cad_transportadora_T28.Preencher_Observacoes;
var i     : Integer;
  ScrollMessage: TWMVScroll;
begin
   mmObservacoes.lines.clear;
   for i := 0 to Transportadora.Observacao.count-1 do
       mmObservacoes.lines.add(Transportadora.Observacao[i]);
...
procedure Tfrm_cad_transportadora_T28.Preencher_Tela_Com_Dados_da_Consulta_CNPJ;
begin
...
procedure Tfrm_cad_transportadora_T28.Preparar_Campos_da_Tela;
begin
...
procedure Tfrm_cad_transportadora_T28.TrataCidade;
