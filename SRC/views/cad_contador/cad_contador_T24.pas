...
uses
  ...
  Classe_Contador, ACBrBase, ACBrSocket, ACBrCEP, Vcl.Grids;

type
  Tfrm_cad_contador_T24 = class(TForm)
    gpData: TGroupBox;
    Label13: TLabel;
    lbInativo: TLabel;
    Label14: TLabel;
    ...
    function Gravar_Contador:Boolean;
    procedure Pesquisar;
    procedure Consultar;
...
var
  frm_cad_contador_T24: Tfrm_cad_contador_T24;
  Contador          : TContador;
  vPodeFechar       : Boolean;
  vMemoLocal        : TMemo;
implementation
...
procedure Tfrm_cad_contador_T24.cxButton1Click(Sender: TObject);
begin
    pesquisar_CNPJ_na_SEFAZ;
end;

procedure Tfrm_cad_contador_T24.pesquisar_CNPJ_na_SEFAZ;
begin
...
begin
   ...
   if not Gravar_Contador then
     exit;

   {
   vNuvem:= TNuvem.Create;
   vNuvem.uploadContador(Contador);
   FreeAndNil(vNuvem);
   }
   Contador.Free;
   Inicio;
...
procedure Tfrm_cad_contador_T24.cxButton28Click(Sender: TObject);
begin
   vPodeFechar:=True;
   Close;
end;

procedure Tfrm_cad_contador_T24.cxButton2Click(Sender: TObject);
begin
   pesquisar_CPF_na_SEFAZ;
end;

procedure Tfrm_cad_contador_T24.pesquisar_CPF_na_SEFAZ;
begin
...
procedure Tfrm_cad_contador_T24.bPesqMunicipioClick(Sender: TObject);
begin
   PesquisaMunicipio;
end;

procedure Tfrm_cad_contador_T24.cxButton4Click(Sender: TObject);
begin
    PesquisaRegiao;
end;

procedure Tfrm_cad_contador_T24.cxButton8Click(Sender: TObject);
begin
  Consultar;
end;

procedure Tfrm_cad_contador_T24.PesquisaRegiao;
Begin
...
procedure Tfrm_cad_contador_T24.PesquisaZona;
begin
...
procedure Tfrm_cad_contador_T24.ACBrCEP1BuscaEfetuada(Sender: TObject);
...
procedure Tfrm_cad_contador_T24.bHistoricoAlteracoesClick(Sender: TObject);
begin
   ...
   begin
     ...
     SQL.Add(' where log_historico like :Contador ');
     ParamByName('Contador').AsString := '%' + 'contador ' + edCodigo.Text + '%';
...
procedure Tfrm_cad_contador_T24.bPesqBairroClick(Sender: TObject);
begin
    PesquisaBairro;
end;

procedure Tfrm_cad_contador_T24.bPesqZonaClick(Sender: TObject);
begin
   PesquisaZona;
end;

procedure Tfrm_cad_contador_T24.btDetalhesBloqueioClick(Sender: TObject);
begin
    if trim(edCodigo.Text) = '' then
       exit;

    // Mostra detalhes do bloqueio...
    // Data, hora, usuário e estação onde ocorreu o bloqueio do Contador
    // ----------------------------------------------------------------------------
    frmCONTADOR_HISTORICO_BLOQUEIOS_CONTHB_T25 :=  TfrmCONTADOR_HISTORICO_BLOQUEIOS_CONTHB_T25.Create(Self);
    with frmCONTADOR_HISTORICO_BLOQUEIOS_CONTHB_T25.sql_CONTADOR_HISTORICO_BLOQUEIOS_CONTHB do
    begin
      Close;
      Sql.Clear;
      Sql.Add('SELECT *                                              ');
      Sql.Add('  FROM CONTADOR_HISTORICO_BLOQUEIOS_CONTHB            ');
      Sql.Add(' WHERE CONTHB_CONTADOR = :CONTHB_CONTADOR             ');
      Sql.Add(' ORDER BY  CONTHB_DTEVENTO DESC, CONTHB_HREVENTO DESC ');
      ParamByName('CONTHB_CONTADOR').AsString := edCODIGO.text;
      Open;
    end;
    frmCONTADOR_HISTORICO_BLOQUEIOS_CONTHB_T25.ShowModal;
    frmCONTADOR_HISTORICO_BLOQUEIOS_CONTHB_T25.Free;
end;

procedure Tfrm_cad_contador_T24.Consultar;
begin
...
function Tfrm_cad_contador_T24.DadosCorretos: Boolean;
...
function Tfrm_cad_contador_T24.FormataIE: Boolean;
begin
   result := true;
...
procedure Tfrm_cad_contador_T24.edBairroExit(Sender: TObject);
begin
...
procedure Tfrm_cad_contador_T24.edCEPExit(Sender: TObject);
...
procedure Tfrm_cad_contador_T24.edCEPKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_contador_T24.edCidadeExit(Sender: TObject);
begin
   TrataCidade;
end;

procedure Tfrm_cad_contador_T24.edCNPJEnter(Sender: TObject);
begin
   (Sender as TEdit).Text := SoNumerosOuISENTO((Sender as TEdit).Text);
end;

procedure Tfrm_cad_contador_T24.edCNPJExit(Sender: TObject);
begin
...
procedure Tfrm_cad_contador_T24.edCNPJKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_contador_T24.edCodigoExit(Sender: TObject);
begin
   Pesquisar;
end;

procedure Tfrm_cad_contador_T24.edCodigoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   if key = vk_F1 then
     Consultar;
...
procedure Tfrm_cad_contador_T24.edCPFExit(Sender: TObject);
begin
...
procedure Tfrm_cad_contador_T24.edCPFKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_contador_T24.edDataNascimentoExit(Sender: TObject);
begin
...
function Tfrm_cad_contador_T24.SelectMunicipio(pMunicipio:String;pMunicipioNome:TEdit):Boolean;
begin
...
procedure Tfrm_cad_contador_T24.edIEExit(Sender: TObject);
begin
...
procedure Tfrm_cad_contador_T24.edIEKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tfrm_cad_contador_T24.edCelKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_contador_T24.edFone1Exit(Sender: TObject);
begin
...
procedure Tfrm_cad_contador_T24.edWhatsAppKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_contador_T24.edZonaExit(Sender: TObject);
begin
...
procedure Tfrm_cad_contador_T24.edNOMEExit(Sender: TObject);
begin
...
procedure Tfrm_cad_contador_T24.edNOMEKeyPress(Sender: TObject; var Key: Char);
begin
   key := fSemAcentos(key);
end;

procedure Tfrm_cad_contador_T24.edNumeroKeyPress(Sender: TObject; var Key: Char);
begin
     key := fLetrasENumeros(key);
end;

procedure Tfrm_cad_contador_T24.edRegiaoExit(Sender: TObject);
begin
...
procedure Tfrm_cad_contador_T24.edRGExit(Sender: TObject);
begin
...
procedure Tfrm_cad_contador_T24.edRG_DataEmissaoExit(Sender: TObject);
begin
   if DataNoFuturo((Sender as TMaskEdit)) then
      (Sender as TEdit).SetFocus;
end;

procedure Tfrm_cad_contador_T24.PesquisaBairro;
begin
...
procedure Tfrm_cad_contador_T24.PesquisaMunicipio;
begin
...
procedure Tfrm_cad_contador_T24.Pesquisar;
var vCodigo:String;
begin
...
procedure Tfrm_cad_contador_T24.FormClose(Sender: TObject;
...
begin
   try
     if vMemoLocal = nil then
        vMemoLocal:=TMemo.Create(frm_cad_contador_T24)
     else
     begin
        vMemoLocal.Free;
        vMemoLocal:=TMemo.Create(frm_cad_contador_T24);
...
procedure Tfrm_cad_contador_T24.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   if key = vk_f1 Then
   begin
...
procedure Tfrm_cad_contador_T24.FormKeyPress(Sender: TObject; var Key: Char);
begin
     if Key = #13 then
     begin
...
procedure Tfrm_cad_contador_T24.FormShow(Sender: TObject);
begin
   Inicio;
end;

function Tfrm_cad_contador_T24.fPessoaFisica: Boolean;
begin
   result := (fTipoPessoa_JF = 'F');
end;

function Tfrm_cad_contador_T24.fPessoaJuridica: Boolean;
begin
   result := (fTipoPessoa_JF = 'J');
end;

function Tfrm_cad_contador_T24.fPreencheu_Algum_Campo_Pessoa_Fisica: Boolean;
begin
   Result := false;
...
function Tfrm_cad_contador_T24.fPreencheu_Algum_Campo_Pessoa_Juridica: Boolean;
begin
   Result := false;
...
function Tfrm_cad_contador_T24.fTipoPessoa_JF: String;
begin
    Result := '';
...
function Tfrm_cad_contador_T24.Gravar_Contador: Boolean;
...
begin
    ...
    try
        ...
        if fPessoaFisica then
        begin
           Contador.NomeFantasia             := edNome.Text;
           Contador.RazaoSocial              := '';
           with Contador.Detalhes.PessoaFisica do
           begin
              CPF            := edCPF.Text;
              RG             := edRG.Text;
        ...
        begin
           Contador.NomeFantasia             := edNomeFantasia.Text;
           Contador.RazaoSocial              := edRazaoSocial.Text;
           with Contador.Detalhes.PessoaFisica do
           begin
              RG             := '';
              RG_OrgaoEmissor:= '';
           ...
           with Contador.Detalhes.PessoaJuridica do
           begin
              CNPJ           := edCNPJ.Text;
              IE             := edIE.Text;
           end;
        ...
        Contador.Status                        := IntToStatusCadastral(rgStatus.ItemIndex);
        Contador.Detalhes.TipoPessoa           := StringToTipoPessoa(fTipoPessoa_JF);
        if rgStatus.ItemIndex = -1 then
           rgStatus.ItemIndex := 0;

        if rgStatus.ItemIndex = 1 then
           Contador.Alteracao.DataBloqueio     := sDataServidor
        else
           Contador.Alteracao.DataBloqueio     := '  /  /  ';
        if rgStatus.ItemIndex = 2 then
           Contador.Alteracao.DataInativo    := sDataServidor
        else
           Contador.Alteracao.DataInativo    := '  /  /  ';


        Contador.Detalhes.Regiao               := edRegiao.Text;
        Contador.Detalhes.Zona                 := edZona.Text;
        Contador.Detalhes.Endereco.Rua         := edRua.Text;
        Contador.Detalhes.Endereco.Numero      := edNumero.Text;
        Contador.Detalhes.Endereco.Bairro      := edBairro.Text;
        Contador.Detalhes.Endereco.Complemento := edComplemento.Text;
        Contador.Detalhes.Endereco.Cidade      := edEnderecoMunicipioIBGE.Text;
        Contador.Detalhes.Endereco.CEP         := edCEP.Text;

        Contador.Detalhes.Contato.Fone1        := edFone1.Text;
        Contador.Detalhes.Contato.Fone2        := edFone2.Text;
        Contador.Detalhes.Contato.Nome         := edNomeContato.Text;
        Contador.Detalhes.Contato.Cel          := edCel.Text;
        Contador.Detalhes.Contato.WhatsApp     := edWhatsApp.Text;
        Contador.Detalhes.Contato.Email1       := edEmail1.Text;
        Contador.Detalhes.Contato.Email2       := edEmail2.Text;

        Lista := TStringList.Create;
        for i := 0 to vMemoLocal.lines.count-1 do
            Lista.Add(vMemoLocal.lines[i]);

        Contador.Observacao                    := Lista;
        result := Contador.Gravar;
    Except

    end;
end;

procedure Tfrm_cad_contador_T24.Inicio;
begin
...
procedure Tfrm_cad_contador_T24.mmObservacoesClick(Sender: TObject);
begin
...
begin
   ...
   rgStatus.ItemIndex := StatusCadastralToInt(Contador.Status);
...
procedure Tfrm_cad_contador_T24.Preencher_Contato;
begin
...
procedure Tfrm_cad_contador_T24.Preencher_Dados_Comuns;
begin
   Preencher_Endereco;
   Preencher_Contato;
...
procedure Tfrm_cad_contador_T24.Preencher_Dados_Pessoa;
begin
   if Contador.Detalhes.TipoPessoa = tpFisica then
      Preencher_Dados_Pessoa_Fisica
   else
      Preencher_Dados_Pessoa_Juridica;
end;

procedure Tfrm_cad_contador_T24.Preencher_Dados_Pessoa_Fisica;
begin
   pgControlPessoa.ActivePage := tsPessoaFisica;
   edNome.Text                := Contador.NomeFantasia;
   edCPF.Text                 := Contador.Detalhes.PessoaFisica.CPF;
   edRG.Text                  := Contador.Detalhes.PessoaFisica.RG;
   edRG_OrgaoEmissor.Text     := Contador.Detalhes.PessoaFisica.RG_OrgaoEmissor;
   edRG_DataEmissao.Text      := Contador.Detalhes.PessoaFisica.RG_DataEmissao;
   edDataNascimento.Text      := Contador.Detalhes.PessoaFisica.DataNascimento;
   cbSexo.ItemIndex           := Contador.Detalhes.PessoaFisica.Sexo;
end;

procedure Tfrm_cad_contador_T24.Preencher_Dados_Pessoa_Juridica;
begin
   pgControlPessoa.ActivePage := tsPessoaJuridica;
   edCNPJ.Text                := Contador.Detalhes.PessoaJuridica.CNPJ;
   edIE.Text                  := Contador.Detalhes.PessoaJuridica.IE;
   edNomeFantasia.Text        := Contador.NomeFantasia;
   edRazaoSocial.Text         := Contador.RazaoSocial;
end;

procedure Tfrm_cad_contador_T24.Preencher_Endereco;
begin
   edRegiao.Text                      := Contador.Detalhes.Regiao;
   edZona.Text                        := Contador.Detalhes.Zona;
   edRua.Text                         := Contador.Detalhes.Endereco.Rua;
   edNumero.Text                      := Contador.Detalhes.Endereco.Numero;
   edBairro.Text                      := Contador.Detalhes.Endereco.Bairro;
   edComplemento.Text                 := Contador.Detalhes.Endereco.Complemento;
   edEnderecoMunicipioIBGE.Text       := Contador.Detalhes.Endereco.Cidade;
   edCEP.Text                         := Contador.Detalhes.Endereco.CEP;
...
procedure Tfrm_cad_contador_T24.Preencher_Historicos;
begin
   edDataCadastro.Text := Contador.Detalhes.DataCadastroString;
   edDataBloqueio.Text := Contador.Alteracao.DataBloqueio;
   edDataInativo.Text  := Contador.Alteracao.DataInativo;
   edUSU.Text          := Contador.Alteracao.Usuario;
   edDT.Text           := Contador.Alteracao.Data;
   edHR.Text           := Contador.Alteracao.Hora;
   edEstacao.Text      := Contador.Alteracao.Estacao;
end;

procedure Tfrm_cad_contador_T24.Preencher_Observacoes;
var i     : Integer;
  ScrollMessage: TWMVScroll;
begin
   mmObservacoes.lines.clear;
   for i := 0 to Contador.Observacao.count-1 do
       mmObservacoes.lines.add(Contador.Observacao[i]);
...
procedure Tfrm_cad_contador_T24.Preencher_Tela_Com_Dados_da_Consulta_CNPJ;
begin
...
procedure Tfrm_cad_contador_T24.Preparar_Campos_da_Tela;
begin
...
procedure Tfrm_cad_contador_T24.TrataCidade;
