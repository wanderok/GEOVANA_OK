...
uses
  ...
  Classe_Motorista, ACBrBase, ACBrSocket, ACBrCEP, Vcl.Grids;

type
  Tfrm_cad_motorista_T26 = class(TForm)
    gpData: TGroupBox;
    Label13: TLabel;
    lbInativo: TLabel;
    Label14: TLabel;
    ...
    function Gravar_Motorista:Boolean;
    procedure Pesquisar;
    procedure Consultar;
...
var
  frm_cad_motorista_T26: Tfrm_cad_motorista_T26;
...
procedure Tfrm_cad_motorista_T26.cxButton1Click(Sender: TObject);
begin
    pesquisar_CNPJ_na_SEFAZ;
end;

procedure Tfrm_cad_motorista_T26.pesquisar_CNPJ_na_SEFAZ;
begin
...
begin
   ...
   if not Gravar_Motorista then
     exit;

   {
   vNuvem:= TNuvem.Create;
   vNuvem.uploadMotorista(Motorista);
   FreeAndNil(vNuvem);
   }
   Motorista.Free;
   Inicio;
...
procedure Tfrm_cad_motorista_T26.cxButton28Click(Sender: TObject);
begin
   vPodeFechar:=True;
   Close;
end;

procedure Tfrm_cad_motorista_T26.cxButton2Click(Sender: TObject);
begin
   pesquisar_CPF_na_SEFAZ;
end;

procedure Tfrm_cad_motorista_T26.pesquisar_CPF_na_SEFAZ;
begin
...
procedure Tfrm_cad_motorista_T26.bPesqMunicipioClick(Sender: TObject);
begin
   PesquisaMunicipio;
end;

procedure Tfrm_cad_motorista_T26.cxButton4Click(Sender: TObject);
begin
    PesquisaRegiao;
end;

procedure Tfrm_cad_motorista_T26.cxButton8Click(Sender: TObject);
begin
  Consultar;
end;

procedure Tfrm_cad_motorista_T26.PesquisaRegiao;
Begin
...
procedure Tfrm_cad_motorista_T26.PesquisaZona;
begin
...
procedure Tfrm_cad_motorista_T26.ACBrCEP1BuscaEfetuada(Sender: TObject);
...
procedure Tfrm_cad_motorista_T26.bHistoricoAlteracoesClick(Sender: TObject);
begin
   ...
   begin
     ...
     SQL.Add(' where log_historico like :Motorista ');
     ParamByName('Motorista').AsString := '%' + 'motorista ' + edCodigo.Text + '%';
...
procedure Tfrm_cad_motorista_T26.bPesqBairroClick(Sender: TObject);
begin
    PesquisaBairro;
end;

procedure Tfrm_cad_motorista_T26.bPesqZonaClick(Sender: TObject);
begin
   PesquisaZona;
end;

procedure Tfrm_cad_motorista_T26.btDetalhesBloqueioClick(Sender: TObject);
begin
    if trim(edCodigo.Text) = '' then
       exit;

    // Mostra detalhes do bloqueio...
    // Data, hora, usuário e estação onde ocorreu o bloqueio do Motorista
    // ----------------------------------------------------------------------------
    frmMOTORISTA_HISTORICO_BLOQUEIOS_MOTHB_T27 :=  TfrmMOTORISTA_HISTORICO_BLOQUEIOS_MOTHB_T27.Create(Self);
    with frmMOTORISTA_HISTORICO_BLOQUEIOS_MOTHB_T27.sql_MOTORISTA_HISTORICO_BLOQUEIOS_MOTHB do
    begin
      Close;
      Sql.Clear;
      Sql.Add('SELECT *                                              ');
    ...
    frmMOTORISTA_HISTORICO_BLOQUEIOS_MOTHB_T27.ShowModal;
    frmMOTORISTA_HISTORICO_BLOQUEIOS_MOTHB_T27.Free;
end;

procedure Tfrm_cad_motorista_T26.Consultar;
begin
    frm_consulta_T7 := Tfrm_consulta_T7.Create(nil);
    frm_consulta_T7.rgConsultar.itemindex := 4; //Motorista
...
function Tfrm_cad_motorista_T26.DadosCorretos: Boolean;
...
begin
   ...
   if NaoPreencheuCamposObrigatoriosOuImportantes(frm_cad_motorista_T26) then
      exit;
...
function Tfrm_cad_motorista_T26.FormataIE: Boolean;
begin
   result := true;
...
procedure Tfrm_cad_motorista_T26.edBairroExit(Sender: TObject);
begin
...
procedure Tfrm_cad_motorista_T26.edCEPExit(Sender: TObject);
...
procedure Tfrm_cad_motorista_T26.edCEPKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_motorista_T26.edCidadeExit(Sender: TObject);
begin
   TrataCidade;
end;

procedure Tfrm_cad_motorista_T26.edCNPJEnter(Sender: TObject);
begin
   (Sender as TEdit).Text := SoNumerosOuISENTO((Sender as TEdit).Text);
end;

procedure Tfrm_cad_motorista_T26.edCNPJExit(Sender: TObject);
begin
...
procedure Tfrm_cad_motorista_T26.edCNPJKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_motorista_T26.edCodigoExit(Sender: TObject);
begin
   Pesquisar;
end;

procedure Tfrm_cad_motorista_T26.edCodigoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   if key = vk_F1 then
     Consultar;
...
procedure Tfrm_cad_motorista_T26.edCPFExit(Sender: TObject);
begin
...
procedure Tfrm_cad_motorista_T26.edCPFKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_motorista_T26.edDataNascimentoExit(Sender: TObject);
begin
...
procedure Tfrm_cad_motorista_T26.edEnderecoMunicipioIBGEExit(Sender: TObject);
begin
    SelectMunicipio(edEnderecoMunicipioIBGE.text,edCidade);
end;

function Tfrm_cad_motorista_T26.SelectMunicipio(pMunicipio:String;pMunicipioNome:TEdit):Boolean;
begin
...
procedure Tfrm_cad_motorista_T26.edIEExit(Sender: TObject);
begin
...
procedure Tfrm_cad_motorista_T26.edIEKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure Tfrm_cad_motorista_T26.edCelKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_motorista_T26.edFone1Exit(Sender: TObject);
begin
   if not TelValido((Sender as TEdit)) then
      (Sender as TEdit).SetFocus;
end;

procedure Tfrm_cad_motorista_T26.edFone2KeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_motorista_T26.edWhatsAppKeyPress(Sender: TObject; var Key: Char);
begin
   key := SoNumero(key);
end;

procedure Tfrm_cad_motorista_T26.edZonaExit(Sender: TObject);
begin
...
procedure Tfrm_cad_motorista_T26.edNOMEExit(Sender: TObject);
begin
...
procedure Tfrm_cad_motorista_T26.edNOMEKeyPress(Sender: TObject; var Key: Char);
begin
   key := fSemAcentos(key);
end;

procedure Tfrm_cad_motorista_T26.edNumeroKeyPress(Sender: TObject; var Key: Char);
begin
     key := fLetrasENumeros(key);
end;

procedure Tfrm_cad_motorista_T26.edRegiaoExit(Sender: TObject);
begin
...
procedure Tfrm_cad_motorista_T26.edRGExit(Sender: TObject);
begin
...
procedure Tfrm_cad_motorista_T26.edRG_DataEmissaoExit(Sender: TObject);
begin
   if DataNoFuturo((Sender as TMaskEdit)) then
      (Sender as TEdit).SetFocus;
end;

procedure Tfrm_cad_motorista_T26.PesquisaBairro;
begin
...
procedure Tfrm_cad_motorista_T26.PesquisaMunicipio;
begin
...
procedure Tfrm_cad_motorista_T26.Pesquisar;
var vCodigo:String;
begin
   ...
   Motorista.Codigo := edCodigo.Text;
   Motorista.Abrir;
...
procedure Tfrm_cad_motorista_T26.FormClose(Sender: TObject;
...
begin
   try
     if vMemoLocal = nil then
        vMemoLocal:=TMemo.Create(frm_cad_motorista_T26)
     else
     begin
        vMemoLocal.Free;
        vMemoLocal:=TMemo.Create(frm_cad_motorista_T26);
...
procedure Tfrm_cad_motorista_T26.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   if key = vk_f1 Then
   begin
...
procedure Tfrm_cad_motorista_T26.FormKeyPress(Sender: TObject; var Key: Char);
begin
     if Key = #13 then
     begin
...
procedure Tfrm_cad_motorista_T26.FormShow(Sender: TObject);
begin
   Inicio;
end;

function Tfrm_cad_motorista_T26.fPessoaFisica: Boolean;
begin
   result := (fTipoPessoa_JF = 'F');
end;

function Tfrm_cad_motorista_T26.fPessoaJuridica: Boolean;
begin
   result := (fTipoPessoa_JF = 'J');
end;

function Tfrm_cad_motorista_T26.fPreencheu_Algum_Campo_Pessoa_Fisica: Boolean;
begin
   Result := false;
...
function Tfrm_cad_motorista_T26.fPreencheu_Algum_Campo_Pessoa_Juridica: Boolean;
begin
   Result := false;
...
function Tfrm_cad_motorista_T26.fTipoPessoa_JF: String;
begin
    Result := '';
...
function Tfrm_cad_motorista_T26.Gravar_Motorista: Boolean;
...
begin
    ...
    try
        ...
        if fPessoaFisica then
        begin
           Motorista.NomeFantasia             := edNome.Text;
           Motorista.RazaoSocial              := '';
           with Motorista.Detalhes.PessoaFisica do
           begin
              CPF            := edCPF.Text;
              RG             := edRG.Text;
        ...
        begin
           Motorista.NomeFantasia             := edNomeFantasia.Text;
           Motorista.RazaoSocial              := edRazaoSocial.Text;
           with Motorista.Detalhes.PessoaFisica do
           begin
              RG             := '';
              RG_OrgaoEmissor:= '';
           ...
           with Motorista.Detalhes.PessoaJuridica do
           begin
              CNPJ           := edCNPJ.Text;
              IE             := edIE.Text;
           end;
        ...
        Motorista.Status                        := IntToStatusCadastral(rgStatus.ItemIndex);
        Motorista.Detalhes.TipoPessoa           := StringToTipoPessoa(fTipoPessoa_JF);
        if rgStatus.ItemIndex = -1 then
           rgStatus.ItemIndex := 0;

        if rgStatus.ItemIndex = 1 then
           Motorista.Alteracao.DataBloqueio     := sDataServidor
        else
           Motorista.Alteracao.DataBloqueio     := '  /  /  ';
        if rgStatus.ItemIndex = 2 then
           Motorista.Alteracao.DataInativo    := sDataServidor
        else
           Motorista.Alteracao.DataInativo    := '  /  /  ';


        Motorista.Detalhes.Regiao               := edRegiao.Text;
        Motorista.Detalhes.Zona                 := edZona.Text;
        Motorista.Detalhes.Endereco.Rua         := edRua.Text;
        Motorista.Detalhes.Endereco.Numero      := edNumero.Text;
        Motorista.Detalhes.Endereco.Bairro      := edBairro.Text;
        Motorista.Detalhes.Endereco.Complemento := edComplemento.Text;
        Motorista.Detalhes.Endereco.Cidade      := edEnderecoMunicipioIBGE.Text;
        Motorista.Detalhes.Endereco.CEP         := edCEP.Text;

        Motorista.Detalhes.Contato.Fone1        := edFone1.Text;
        Motorista.Detalhes.Contato.Fone2        := edFone2.Text;
        Motorista.Detalhes.Contato.Nome         := edNomeContato.Text;
        Motorista.Detalhes.Contato.Cel          := edCel.Text;
        Motorista.Detalhes.Contato.WhatsApp     := edWhatsApp.Text;
        Motorista.Detalhes.Contato.Email1       := edEmail1.Text;
        Motorista.Detalhes.Contato.Email2       := edEmail2.Text;

        Lista := TStringList.Create;
        for i := 0 to vMemoLocal.lines.count-1 do
            Lista.Add(vMemoLocal.lines[i]);

        Motorista.Observacao                    := Lista;
        result := Motorista.Gravar;
    Except

    end;
end;

procedure Tfrm_cad_motorista_T26.Inicio;
begin
...
procedure Tfrm_cad_motorista_T26.mmObservacoesClick(Sender: TObject);
begin
...
begin
   ...
   rgStatus.ItemIndex := StatusCadastralToInt(Motorista.Status);
...
procedure Tfrm_cad_motorista_T26.Preencher_Contato;
begin
   edFone1.Text             := Motorista.Detalhes.Contato.Fone1;
   edFone2.Text             := Motorista.Detalhes.Contato.Fone2;
   edNomeContato.Text       := Motorista.Detalhes.Contato.Nome;
   edCel.Text               := Motorista.Detalhes.Contato.Cel;
   edWhatsApp.Text          := Motorista.Detalhes.Contato.WhatsApp;
   edEmail1.Text            := Motorista.Detalhes.Contato.Email1;
   edEmail2.Text            := Motorista.Detalhes.Contato.Email2;
end;

procedure Tfrm_cad_motorista_T26.Preencher_Dados_Comuns;
begin
   Preencher_Endereco;
   Preencher_Contato;
...
procedure Tfrm_cad_motorista_T26.Preencher_Dados_Pessoa;
begin
   if Motorista.Detalhes.TipoPessoa = tpFisica then
      Preencher_Dados_Pessoa_Fisica
   else
      Preencher_Dados_Pessoa_Juridica;
end;

procedure Tfrm_cad_motorista_T26.Preencher_Dados_Pessoa_Fisica;
begin
   pgControlPessoa.ActivePage := tsPessoaFisica;
   edNome.Text                := Motorista.NomeFantasia;
   edCPF.Text                 := Motorista.Detalhes.PessoaFisica.CPF;
   edRG.Text                  := Motorista.Detalhes.PessoaFisica.RG;
   edRG_OrgaoEmissor.Text     := Motorista.Detalhes.PessoaFisica.RG_OrgaoEmissor;
   edRG_DataEmissao.Text      := Motorista.Detalhes.PessoaFisica.RG_DataEmissao;
   edDataNascimento.Text      := Motorista.Detalhes.PessoaFisica.DataNascimento;
   cbSexo.ItemIndex           := Motorista.Detalhes.PessoaFisica.Sexo;
end;

procedure Tfrm_cad_motorista_T26.Preencher_Dados_Pessoa_Juridica;
begin
   pgControlPessoa.ActivePage := tsPessoaJuridica;
   edCNPJ.Text                := Motorista.Detalhes.PessoaJuridica.CNPJ;
   edIE.Text                  := Motorista.Detalhes.PessoaJuridica.IE;
   edNomeFantasia.Text        := Motorista.NomeFantasia;
   edRazaoSocial.Text         := Motorista.RazaoSocial;
end;

procedure Tfrm_cad_motorista_T26.Preencher_Endereco;
begin
   edRegiao.Text                      := Motorista.Detalhes.Regiao;
   edZona.Text                        := Motorista.Detalhes.Zona;
   edRua.Text                         := Motorista.Detalhes.Endereco.Rua;
   edNumero.Text                      := Motorista.Detalhes.Endereco.Numero;
   edBairro.Text                      := Motorista.Detalhes.Endereco.Bairro;
   edComplemento.Text                 := Motorista.Detalhes.Endereco.Complemento;
   edEnderecoMunicipioIBGE.Text       := Motorista.Detalhes.Endereco.Cidade;
   edCEP.Text                         := Motorista.Detalhes.Endereco.CEP;
...
procedure Tfrm_cad_motorista_T26.Preencher_Historicos;
begin
   edDataCadastro.Text := Motorista.Detalhes.DataCadastroString;
   edDataBloqueio.Text := Motorista.Alteracao.DataBloqueio;
   edDataInativo.Text  := Motorista.Alteracao.DataInativo;
   edUSU.Text          := Motorista.Alteracao.Usuario;
   edDT.Text           := Motorista.Alteracao.Data;
   edHR.Text           := Motorista.Alteracao.Hora;
   edEstacao.Text      := Motorista.Alteracao.Estacao;
end;

procedure Tfrm_cad_motorista_T26.Preencher_Observacoes;
var i     : Integer;
  ScrollMessage: TWMVScroll;
begin
   mmObservacoes.lines.clear;
   for i := 0 to Motorista.Observacao.count-1 do
       mmObservacoes.lines.add(Motorista.Observacao[i]);
...
procedure Tfrm_cad_motorista_T26.Preencher_Tela_Com_Dados_da_Consulta_CNPJ;
begin
...
procedure Tfrm_cad_motorista_T26.Preparar_Campos_da_Tela;
begin
...
procedure Tfrm_cad_motorista_T26.TrataCidade;
