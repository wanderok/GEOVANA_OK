...
unit MOTORISTA_HISTORICO_BLOQUEIOS_MOTHB_T26;
{
Ano:2020
================================================================================
...
type
  TfrmMOTORISTA_HISTORICO_BLOQUEIOS_MOTHB_T26 = class(TForm)
...
var
  frmMOTORISTA_HISTORICO_BLOQUEIOS_MOTHB_T26: TfrmMOTORISTA_HISTORICO_BLOQUEIOS_MOTHB_T26;
...
procedure TfrmMOTORISTA_HISTORICO_BLOQUEIOS_MOTHB_T26.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
     if key = #27 then
     begin
