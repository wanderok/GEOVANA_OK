object Frm_cad_cliente_SMC_T35: TFrm_cad_cliente_SMC_T35
  Left = 0
  Top = 0
  AutoSize = True
  Caption = 'Detalhes de Cliente SMC'
  ClientHeight = 478
  ClientWidth = 669
  Color = clBtnFace
  ...
  object edConsultor: TEdit
    ...
    ParentFont = False
    TabOrder = 3
    OnExit = edConsultorExit
    OnKeyDown = edConsultorKeyDown
  end
  ...
  object Panel5: TPanel
    ...
    Width = 311
    Height = 37
    Caption = 'C E R T I F I C A D O  D I G I T A L'
    Color = 15254945
    ParentBackground = False
    TabOrder = 14
  end
