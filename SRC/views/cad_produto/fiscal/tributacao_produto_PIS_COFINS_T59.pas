unit tributacao_produto_PIS_COFINS_T59;
...
type
  Tfrm_tributacao_produto_PIS_COFINS_T59 = class(TForm)
    cxButton1: TcxButton;
    cxButton2: TcxButton;
    lbNomeDaTela: TLabel;
    Panel1: TPanel;
    ...
    procedure edCEST_CESTNomeClick(Sender: TObject);
...
var
  frm_tributacao_produto_PIS_COFINS_T59: Tfrm_tributacao_produto_PIS_COFINS_T59;
...
procedure Tfrm_tributacao_produto_PIS_COFINS_T59.cxButton2Click(Sender: TObject);
begin
   Close;
end;

procedure Tfrm_tributacao_produto_PIS_COFINS_T59.cxButton7Click(Sender: TObject);
begin
   Pesquisa_CEST_NCM;
end;

procedure Tfrm_tributacao_produto_PIS_COFINS_T59.edCEST_CESTExit(Sender: TObject);
begin
   Mostra_CEST;
end;

procedure Tfrm_tributacao_produto_PIS_COFINS_T59.edCEST_CESTNomeClick(
  Sender: TObject);
begin
   mmDESCRICAO.Text := edCEST_CESTNome.Text;
end;

procedure Tfrm_tributacao_produto_PIS_COFINS_T59.edCEST_NCMExit(Sender: TObject);
begin
   Mostra_NCM;
end;

procedure Tfrm_tributacao_produto_PIS_COFINS_T59.edCEST_NCMNomeClick(
  Sender: TObject);
begin
   mmDESCRICAO.Text := edCEST_NCMNome.Text;
end;

procedure Tfrm_tributacao_produto_PIS_COFINS_T59.edCSOSNNomeClick(Sender: TObject);
begin
   mmDESCRICAO.Text := edCSOSNNome.Text;
end;

procedure Tfrm_tributacao_produto_PIS_COFINS_T59.FormKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
   if key = vk_f1 then
   begin
      if (edCEST_NCM.Focused ) or
         (edCEST_CEST.Focused) then
      begin
         Pesquisa_CEST_NCM;
         exit
      end;
...
procedure Tfrm_tributacao_produto_PIS_COFINS_T59.Mostra_CEST;
begin
   mmDESCRICAO.Lines.Clear;
   edCEST_CESTNome.Text := '';
   if edCEST_CEST.text = '' then
      exit;
...
procedure Tfrm_tributacao_produto_PIS_COFINS_T59.Mostra_NCM;
begin
   mmDESCRICAO.Lines.Clear;
   edCEST_NCMNome.Text := '';
...
procedure Tfrm_tributacao_produto_PIS_COFINS_T59.Pesquisa_CEST_NCM;
begin
   frm_NCMSH_CEST_T44:= Tfrm_NCMSH_CEST_T44.Create(self);
   frm_NCMSH_CEST_T44.ShowModal;
   edCEST_CEST.Text := T44_CEST_CEST;
