object frm_CSOSN_T54: Tfrm_CSOSN_T54
  Left = 0
  Top = 0
  AutoSize = True
  ...
  object Label1: TLabel
    ...
    Width = 503
    Height = 19
    Caption = 'C'#243'digo de Situa'#231#227'o da Opera'#231#227'o do Simples Nacional - CSOSN'
    Color = clHighlight
    Font.Charset = DEFAULT_CHARSET
  ...
  object gdNat: TcxGrid
    ...
    object tbView: TcxGridDBTableView
      ...
      object CSOSN_CODIGO: TcxGridDBColumn
        Caption = 'CSOSN'
        DataBinding.FieldName = 'CSOSN_CODIGO'
      ...
      object CSOSN_DESCRICAO: TcxGridDBColumn
        Caption = 'Descri'#231#227'o'
        DataBinding.FieldName = 'CSOSN_DESCRICAO'
        Options.Editing = False
        Width = 660
      end
    end
