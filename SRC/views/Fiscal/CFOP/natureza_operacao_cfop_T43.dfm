object frm_natureza_operacao_cfop_T43: Tfrm_natureza_operacao_cfop_T43
  ...
  object SQL_CFOP: TFDQuery
    Connection = DM.Database1
    SQL.Strings = (
      'select * from NATUREZADEOPERACAO_NATOP')
    Left = 384
    Top = 144
    object SQL_CFOPCODIGO: TStringField
      FieldName = 'CODIGO'
      Size = 4
    end
    object SQL_CFOPFORAESTADO: TStringField
      FieldName = 'FORAESTADO'
      Size = 1
    end
    object SQL_CFOPES: TStringField
      FieldName = 'ES'
      Size = 1
    end
    object SQL_CFOPICMS: TStringField
      FieldName = 'ICMS'
      Size = 1
    end
    object SQL_CFOPNAT_TIPO: TStringField
      FieldName = 'NAT_TIPO'
      Size = 2
    end
    ...
    object SQL_CFOPDESCRICAO2: TStringField
