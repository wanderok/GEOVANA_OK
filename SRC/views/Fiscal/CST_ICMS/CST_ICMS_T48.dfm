object frm_CST_ICMS_T48: Tfrm_CST_ICMS_T48
  Left = 0
  Top = 0
  AutoSize = True
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'C'#243'digo da Situa'#231#227'o Tribut'#225'ria (CST) do ICMS'
  ClientHeight = 473
  ClientWidth = 915
  Color = clWhite
  ...
  object gdNat: TcxGrid
    ...
    object tbView: TcxGridDBTableView
      ...
      DataController.DataSource = DS_ICMS
      ...
      object tbViewColumn1: TcxGridDBColumn
        Caption = 'CST ICMS'
        DataBinding.FieldName = 'ICMS_CODIGO'
      ...
      object tbViewColumn2: TcxGridDBColumn
        ...
        DataBinding.FieldName = 'ICMS_DESCRICAO'
        Options.Editing = False
  ...
  object SQL_ICMS: TFDQuery
    Connection = DM.Database1
    SQL.Strings = (
      'select * from CST_ICMS')
    Left = 576
    Top = 192
    object SQL_ICMSICMS_CODIGO: TStringField
      FieldName = 'ICMS_CODIGO'
      Origin = 'ICMS_CODIGO'
      Size = 10
    end
    object SQL_ICMSICMS_DESCRICAO: TStringField
      FieldName = 'ICMS_DESCRICAO'
      Origin = 'ICMS_DESCRICAO'
      Size = 255
    end
  end
