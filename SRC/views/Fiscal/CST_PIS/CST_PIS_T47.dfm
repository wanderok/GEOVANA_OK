object frm_CST_PIS_T47: Tfrm_CST_PIS_T47
  Left = 0
  Top = 0
  AutoSize = True
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'C'#243'digo da Situa'#231#227'o Tribut'#225'ria (CST) do PIS'
  ClientHeight = 473
  ClientWidth = 915
  Color = clWhite
  ...
  object gdNat: TcxGrid
    ...
    object tbView: TcxGridDBTableView
      ...
      DataController.DataSource = DS_PIS
      ...
      object tbViewColumn1: TcxGridDBColumn
        Caption = 'CST PIS'
        DataBinding.FieldName = 'PIS_CODIGO'
      ...
      object tbViewColumn2: TcxGridDBColumn
        ...
        DataBinding.FieldName = 'PIS_DESCRICAO'
        Options.Editing = False
  ...
  object SQL_PIS: TFDQuery
    Connection = DM.Database1
    SQL.Strings = (
      'select * from CST_PIS')
    Left = 576
    Top = 192
    object SQL_PISPIS_CODIGO: TStringField
      FieldName = 'PIS_CODIGO'
      Origin = 'PIS_CODIGO'
      Size = 10
    end
    object SQL_PISPIS_DESCRICAO: TStringField
      FieldName = 'PIS_DESCRICAO'
      Origin = 'PIS_DESCRICAO'
      Size = 255
    end
  end
  object DS_PIS: TDataSource
    DataSet = SQL_PIS
    Left = 656
    Top = 168
  end
