...
type
  Tfrm_aviso_rg_existente = class(TForm)
    Image1: TImage;
    Label3: TLabel;
    cxButton2: TcxButton;
    lbNome: TLabel;
...
var
  frm_aviso_rg_existente: Tfrm_aviso_rg_existente;

implementation

{$R *.dfm}

procedure Tfrm_aviso_rg_existente.cxButton1Click(Sender: TObject);
begin
Close;
end;
