...
type
  Tfrm_aviso_cpf_existente = class(TForm)
    Image1: TImage;
    Label3: TLabel;
    cxButton2: TcxButton;
    lbNome: TLabel;
...
var
  frm_aviso_cpf_existente: Tfrm_aviso_cpf_existente;

implementation

{$R *.dfm}

procedure Tfrm_aviso_cpf_existente.cxButton1Click(Sender: TObject);
begin
Close;
end;
