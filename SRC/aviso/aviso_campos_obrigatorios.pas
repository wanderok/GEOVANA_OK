unit aviso_campos_obrigatorios;
...
type
  Tfrm_campos_obrigatorios = class(TForm)
    Image1: TImage;
    Label3: TLabel;
    Label1: TLabel;
    Label2: TLabel;
...
var
  frm_campos_obrigatorios: Tfrm_campos_obrigatorios;

implementation

{$R *.dfm}

procedure Tfrm_campos_obrigatorios.cxButton1Click(Sender: TObject);
begin
Close;
end;
